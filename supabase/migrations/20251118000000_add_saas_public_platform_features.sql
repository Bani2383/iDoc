...
CREATE INDEX idx_bundle_translations_bundle ON bundle_translations(bundle_id);
...
CREATE INDEX idx_analytics_events_template ON analytics_events(template_id);
...
CREATE INDEX idx_generation_queue_priority ON document_generation_queue(priority DESC, created_at);
CREATE INDEX idx_generation_queue_user ON document_generation_queue(user_id);
...
CREATE INDEX idx_upsell_purchases_user ON upsell_purchases(user_id);
CREATE INDEX idx_upsell_purchases_purchase ON upsell_purchases(purchase_id);
...
-- ================================================================
-- 6. EXTENSIONS DES TABLES EXISTANTES
-- ================================================================
