...
BEGIN
  ...
  -- Count removed indexes (should be 0)
  ...
  RAISE NOTICE '✅ Foreign Key Indexes Created: %/9', idx_count;
  RAISE NOTICE '✅ Unused Indexes Removed: % remaining (should be 0)', removed_count;
  
  IF idx_count = 9 AND removed_count = 0 THEN
